...
<script>
    ...
    function doValidation() {
     ...
     if(jQuery('#duo_PEnabled').attr('checked')) {

         if($("input[name='cust_pro_prop_duo#host']").val() == ""){
             CARBON.showWarningDialog('Host value cannot be empty');
             return false;
         }

         if($("input[name='cust_pro_prop_duo#ikey']").val() == ""){
             CARBON.showWarningDialog('Integration key cannot be empty');
             return false;
         }

         if($("input[name='cust_pro_prop_duo#skey']").val() == ""){
             CARBON.showWarningDialog('Secret key cannot be empty');
             return false;
         }
