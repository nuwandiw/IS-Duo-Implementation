...
var Duo = {
    init: function(options) {
        ...
        Duo._post_action = options.post_action;
         ...
         /* sessionDataKey for IS */
        if (!options.sessionDataKey) {
            options.sessionDataKey = '';
        }
        Duo._sessionDataKey = options.sessionDataKey;
    ...
    ready: function() {
        ...
        D.receiveMessage(function(msg) {
            ...
            var input_sessionDataKey = D('<input type="hidden">').attr('name', "sessionDataKey").val(Duo._sessionDataKey);
            ...
            form.append(input);
            form.append(input_sessionDataKey);
            form.submit();
        }, 'https://' + Duo._host);
    }
};
